...
/// Workout1_Journal
class Workout1JournalScreen extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onSkip;
  final VoidCallback onBack;
  const Workout1JournalScreen({required this.onNext, required this.onSkip, required this.onBack, super.key});

  @override
  State<Workout1JournalScreen> createState() => _Workout1JournalScreenState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FadeIn(
              child: Text(
                'What story did your system tell you today?',
            ...
            FadeIn(
              ...
              child: Text(
                'And what was the real evidence?',
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          tag.toUpperCase(),
          style: AppTypography.columnHeader.copyWith(fontSize: 8, color: isSelected ? AppColors.accent : AppColors.ink.withOpacity(0.4)),
        ),
      ),
    );
  }
...
/// Workout1_Journal_Confirm
class Workout1JournalConfirmScreen extends StatelessWidget {
  final VoidCallback onContinue;
  final VoidCallback onHome;
  const Workout1JournalConfirmScreen({required this.onContinue, required this.onHome, super.key});
