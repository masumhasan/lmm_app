...
class ClosingMainScreen extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onBack;
  const ClosingMainScreen({required this.onNext, required this.onBack, super.key});

  @override
  State<ClosingMainScreen> createState() => _ClosingMainScreenState();
}

class _ClosingMainScreenState extends State<ClosingMainScreen> {
  ...
  Future<void> _initAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audios/voiceovers/Workout0_Closing_Main.mp3');
      _audioPlayer.play();
